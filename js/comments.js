...
var commentsTotalPage, commentsCurrentPageSize, commentsPageNum = 1, commentsPageSize = 3;

// 打开评论页面
$("#moreUnfold .button .cmt_icon").on("click", () => {
...
function commentsThunmUpStatus() {
    ...
    // 注销点赞click事件
    $("#comments .body .listbox .every .thumbupbox .finger").unbind('click');
    // 注册点赞click事件
...
$("#comments .footer .release").on("click", () => {
    let contentOriginal = $("#comments .footer textarea").val();
    // 清除空格
    let content = $("#comments .footer textarea").val().replace(/\s/g, "");
