 ...
 */
var $appid, $timestamp, $noncestr, $signature, $description, $title, $imgUrl;
...
$.ajax({
  ...
  success: function success(res) {
    ...
    wx.config({
      ...
      'updateTimelineShareData', 'updateAppMessageShareData', 'openLocation', 'getLocation', 'chooseImage']
    });
  },
